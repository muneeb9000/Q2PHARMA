...
<div class="main-content app-content">
    <div class="container-fluid">
        <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
            <h1 class="page-title fw-semibold fs-18 mb-0">Edit City</h1>
                        ...
                        <div class="card-body vstack gap-3">
                            <form action="{{ route('city.update', $city->id) }}" method="POST">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select id="company-dropdown" name="company_id" class="form-control js-example-basic-single">
                                        ...
                                        @foreach($companies as $company)
                                            <option value="{{ $company->id }}" {{ $company->id == $city->company_id ? 'selected' : '' }}>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="form-text" name="city_name" value="{{ $city->city_name }}" placeholder="City Name">
                                </div>
