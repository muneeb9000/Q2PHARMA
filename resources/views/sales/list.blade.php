            ...
            <div class="ms-md-1 ms-0">
                @php
                    $breadcrumbs = [
                        ...
                        ['name' => 'Sales List', 'icon' => 'ti ti-plus'],
                    ];
                @endphp
                                                   ...
                                                   @php
                                                    ...
                                                    <td>
                                                     <div class="hstack gap-2 fs-15">
                                                            ...
                                                            <a href="{{ route('sales.show', $sale->id) }}" class="btn btn-icon btn-sm btn-primary-light">
                                                                <i class="ri-eye-line"></i>
                                                            </a>
                                                                <!-- Edit Button -->
                                                                <a href="{{ route('sales.edit', $sale->id) }}" class="btn btn-icon btn-sm btn-info-light">
                                                                    <i class="ri-edit-line"></i>
                                                                </a>

                                                                <!-- Delete Button -->
                                                                <form method="POST" action="{{ route('sales.destroy', $sale->id) }}" style="display:inline-block;">
                                                                    @csrf
                                                                    @method('DELETE')
