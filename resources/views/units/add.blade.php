...
<div class="main-content app-content">
    <div class="container-fluid">
        <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
            <h1 class="page-title fw-semibold fs-18 mb-0">Units</h1>
            <div class="ms-md-1 ms-0">
                @php
                    $breadcrumbs = [
                        ['name' => 'Dashboard', 'url' => route('home'), 'icon' => 'ti ti-home-1'],
                        ['name' => 'Units', 'icon' => 'ti ti-building'],
                    ];
                @endphp
                    ...
                    <div class="card custom-card">
                        <div class="card-body">
                            <form action="{{ route('units.store') }}" method="POST">
                                ...
                                <div class="mb-3">
                                    <label for="form-text" class="form-label fs-14 text-dark">Unit Name</label>
                                    <input type="text" class="form-control" id="form-text" name="name" placeholder="Unit Name">
                                </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="hstack gap-2 fs-15">
                                                        <a href="{{ route('units.edit', $unit->id) }}" class="btn btn-icon btn-sm btn-info-light m-1"><i class="ri-edit-line"></i></a>
