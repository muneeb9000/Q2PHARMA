            ...
            <div class="ms-md-1 ms-0">
                @php
                    $breadcrumbs = [
                        ...
                        ['name' => 'Edit Product', 'icon' => 'ti ti-pencil'],
                    ];
                @endphp
                            ...
                            <form method="POST" action="{{ route('products.update', $product->id) }}">
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-xl-6">
                                        ...
                                        <input type="text" class="form-control @error('code') is-invalid @enderror" id="code" name="code" placeholder="Product Code" value="{{ old('code', $product->code) }}" required>
                                        @error('code')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="col-xl-6">
                                        ...
                                        <input type="text" class="form-control @error('barcode') is-invalid @enderror" id="barcode" name="barcode" placeholder="Barcode" value="{{ old('barcode', $product->barcode) }}">
                                        @error('barcode')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="col-xl-6">
                                        ...
                                        <input type="text" class="form-control @error('sku') is-invalid @enderror" id="sku" name="sku" placeholder="SKU" value="{{ old('sku', $product->sku) }}" required>
                                        @error('sku')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="col-xl-6">
                                        ...
                                        <input type="text" class="form-control @error('batch_number') is-invalid @enderror" id="batch_number" name="batch_number" placeholder="Batch Number" value="{{ old('batch_number', $product->batch_number) }}">
                                        @error('batch_number')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="col-xl-6">
                                        ...
                                        <input type="number" class="form-control @error('reorder_level') is-invalid @enderror" id="reorder_level" name="reorder_level" placeholder="Reorder Level" value="{{ old('reorder_level', $product->reorder_level) }}" required>
                                        @error('reorder_level')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="col-xl-6">
                                        ...
                                        <input type="text" class="form-control @error('strength') is-invalid @enderror" id="strength" name="strength" placeholder="Strength" value="{{ old('strength', $product->strength) }}">
                                        @error('strength')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-xl-6">
                                        ...
                                        <input type="number" class="form-control @error('unit_ratio') is-invalid @enderror" id="unit_ratio" name="unit_ratio" placeholder="Unit Ratio" value="{{ old('unit_ratio', $product->unit_ratio) }}" required>
                                        @error('unit_ratio')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-xl-6">
                                        ...
                                        <input type="number" step="0.01" class="form-control @error('purchase_price') is-invalid @enderror" id="purchase_price" name="purchase_price" placeholder="Purchase Price" value="{{ old('purchase_price', $product->purchase_price) }}" required>
                                    ...
                                    <div class="col-xl-6">
                                        ...
                                        <input type="number" step="0.01" class="form-control @error('sale_price') is-invalid @enderror" id="sale_price" name="sale_price" placeholder="Sale Price" value="{{ old('sale_price', $product->sale_price) }}" required>
                                        @error('sale_price')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
...
<!-- Add jQuery and AJAX script to populate dropdowns -->
        ...
        if (companyId) {
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $('#category_id').val('{{ old('category_id', $product->category_id) }}').trigger('change'); // Ensure Select2 updates
                },
        ...
        if (companyId) {
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $('#purchase_unit_id').empty().append('<option value="">Select Purchase Unit</option>');
                    $('#sale_unit_id').empty().append('<option value="">Select Sale Unit</option>');
                    $.each(data, function(index, unit) {
                        $('#purchase_unit_id').append('<option value="'+ unit.id +'">'+ unit.name +'</option>');
                        $('#sale_unit_id').append('<option value="'+ unit.id +'">'+ unit.name +'</option>');
                    });
                    $('#purchase_unit_id').val('{{ old('purchase_unit_id', $product->purchase_unit_id) }}').trigger('change'); // Ensure Select2 updates
                    $('#sale_unit_id').val('{{ old('sale_unit_id', $product->sale_unit_id) }}').trigger('change'); // Ensure Select2 updates
                },
                error: function(xhr, status, error) {
                    console.error('AJAX Error:', error); // Debugging line
                }
