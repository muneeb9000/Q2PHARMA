            ...
            <div class="ms-md-1 ms-0">
                @php
                    $breadcrumbs = [
                        ...
                        ['name' => 'Product Details', 'icon' => 'ti ti-plus'],
                    ];
                @endphp
                                                            ...
                                                            <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
                                                                <div class="ecommerce-assurance">
                                                                    ...
                                                                    @php
                                                                        ...
                                                                        $status = str_replace(['active', 'inactive'], ['ACTIVE', 'IN - ACTIVE'], $status);
                                                                    @endphp
                                                                    {{ $status }}
                                                                </p>
                                                                </div>
                                                                ...
                                                                <div class="ecommerce-assurance">
                                                                   ...
                                                                   <p class="fs-14 fw-semibold mb-0">
                                                                    ...
                                                                    @php
                                                                        ...
                                                                        $status = str_replace(['in_stock', 'out_of_stock'], ['IN - STOCK', 'OUT OF STOCK'], $status);
                                                                    @endphp
                                                                    {{ $status }}
                                                                </p>
                                                                </div>
