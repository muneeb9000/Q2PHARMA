            ...
            <div class="ms-md-1 ms-0">
                @php
                    $breadcrumbs = [
                        ...
                        ['name' => 'Categories', 'icon' => 'ti ti-building'],
                    ];
                @endphp
                        ...
                        <div class="card-body">
                            <form action="{{ route('category.store') }}" method="POST">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="form-text" name="name" placeholder="Category Name">
                                </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="hstack gap-2 fs-15">
                                                        <a href="{{ route('category.edit', $category->id) }}" class="btn btn-icon btn-sm btn-info-light m-1"><i class="ri-edit-line"></i></a>
